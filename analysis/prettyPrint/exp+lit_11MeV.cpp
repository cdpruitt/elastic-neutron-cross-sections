{
    ...
    string expSn112_4MGraphName = "Sn112(n,n) [11 MeV, 4M]";
    string expSn112_6MGraphName = "Sn112(n,n) [11 MeV, 6M]";
    string expSn124_4MGraphName = "Sn124(n,n) [11 MeV, 4M]";
    string expSn124_6MGraphName = "Sn124(n,n) [11 MeV, 6M]";

    TGraphErrors* ExpSn112_4MGraph = (TGraphErrors*)expFile->Get(expSn112_4MGraphName.c_str());
    TGraphErrors* ExpSn112_6MGraph = (TGraphErrors*)expFile->Get(expSn112_6MGraphName.c_str());
    TGraphErrors* ExpSn124_4MGraph = (TGraphErrors*)expFile->Get(expSn124_4MGraphName.c_str());
    ...
    //mg->Add(Sn118Graph);
    //mg->Add(Sn116Graph);
    mg->Add(ExpSn112_4MGraph);
    mg->Add(ExpSn112_6MGraph);
    mg->Add(ExpSn124_4MGraph);
    ...
    ExpSn112_4MGraph->SetLineColor(kRed-9);
    ExpSn112_4MGraph->SetLineWidth(5);
    ExpSn112_4MGraph->SetLineStyle(0);
    ExpSn112_4MGraph->SetMarkerColor(kRed-9);
    ExpSn112_4MGraph->SetMarkerStyle(33);
    ExpSn112_4MGraph->SetMarkerSize(4);

    ExpSn112_6MGraph->SetLineColor(kRed-9);
    ExpSn112_6MGraph->SetLineWidth(5);
    ...
    ExpSn124_4MGraph->SetLineColor(kRed+1);
    ExpSn124_4MGraph->SetLineWidth(5);
    ExpSn124_4MGraph->SetLineStyle(0);
    ExpSn124_4MGraph->SetMarkerColor(kRed+1);
    ExpSn124_4MGraph->SetMarkerStyle(33);
    ExpSn124_4MGraph->SetMarkerSize(4);

    ExpSn124_6MGraph->SetLineColor(kRed+1);
    ExpSn124_6MGraph->SetLineWidth(5);
    ExpSn124_6MGraph->SetLineStyle(0);
