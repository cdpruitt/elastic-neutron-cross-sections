...
around and traveling through the nucleus. Thus, the amplitude of the
oscillations $\rho$ is connected to inelastic scattering and the 
period of oscillation $\delta$ is connected to elastic scattering.
...
difficult to constrain as they require both proton and neutron scattering data. Experimental 
...
Absolute \totEs for all isotopic targets are shown  along with isotopic literature
data (where it exists) in Figs. \ref{TwoPanelO, TwoPanelNi, TwoPanelRh, TwoPanelSn}. 
To calculate the relative difference between our data and literature data with different 
binning, linear interpolation was used to prepare a literature dataset with the
same bins as our data (this is important when the cross section varies rapidly,
as for $^{\text{nat}}$C below 10 MeV).
